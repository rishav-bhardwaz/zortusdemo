...
const GenerateQuizDocument: React.FC = () => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        setStatus("Generating Quiz Document...");

        try {
            const response = await fetch(`http://15.206.99.14:5000/quiz/generate_mcqs_manual_docx?${queryParams}`, {
                method: 'GET'
            });
            ...
            setStatus("Quiz Document Generated Successfully!");
        } catch (error: any) {
            console.error('Error:', error);
            setStatus("Error generating quiz document. Please try again.");
        }
    };

    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
            <h1 className="text-3xl font-semibold text-gray-800 mb-4">Generate Quiz Document</h1>
